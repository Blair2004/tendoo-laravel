	...
	return function( fields ){
		...
		_.each(
			...
			function( field ){
				...
				{
					var id      = field.model + '-input-id'; 
					var countrySelector  = document.getElementById(id);
					if(countrySelector.selectedIndex == 0){
						countrySelector.options[0] = new Option("Choisissez un pays","");
						countrySelector.selectedIndex = 0;
						for (var i=0; i < country_arr.length; i++){
							var o = new Option(country_arr[i], country_arr[i]);
							o.setAttribute("class", "ng-binding ng-scope");
							countrySelector.options[countrySelector.length] = o;
						}
					}
				}
				if ( field.subType == 'state' ) 
				{
					var parentId = field.country + '-input-id';
					var countrySelector  = document.getElementById(parentId);
					var fieldId = field.model + '-input-id';
					var stateSelector = document.getElementById(fieldId);
					countrySelector.onchange = function()
					{
						var countryIndex = countrySelector.selectedIndex;
						stateSelector.length = 0;
						stateSelector.options[0] = new Option('Choisissez la region',"");
						...
						for (var i=0; i < state_arr.length; i++) 
						{
							...
							o.setAttribute("class","ng-binding ng-scope");
							stateSelector.options[stateSelector.length] = o; 
						}
					}  					
				}	
			}
