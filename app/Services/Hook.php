 ...
 */
    ...
    /**
     * filter Hooks a function or method to a specific filter action.
     * @access public
     * @since 0.1
    ...
    /**
     * action Hooks a function on to a specific action.
     * @access public
     * @since 0.1
     ...
     * @param int $accepted_args optional. The number of arguments the function accept (default 1).
     */
    public function action($tag, $function_to_add, $priority = 10, $accepted_args = 1)
    {
